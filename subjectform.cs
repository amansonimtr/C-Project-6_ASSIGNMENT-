...
namespace project2
{
    ...
    {
        private const string conn = "Data Source=DESKTOP-SE2MU48;Initial Catalog=Facultydatabase; Integrated security =True";
        public subjectform()
        {
            InitializeComponent();
        }
        ...
        {
            // TODO: This line of code loads data into the 'facultydatabaseSubject.Subjects' table. You can move, or remove it, as needed.
            this.subjectsTableAdapter.Fill(this.facultydatabaseSubject.Subjects);
